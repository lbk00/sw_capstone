...
import com.example.capstone.Supplier.SupplierDTO;
...
@Data
public class SupplierResponseDTO<E extends SupplierDTO>{
    ...
    public SupplierResponseDTO(List<E> dtoList, List<SupplierDTO> supplierList, PageRequestDTO pageRequestDTO, long total) {

        this.dtoList = dtoList.stream()
                .sorted(Comparator.comparingLong(SupplierDTO::getSupplierId))
